...
from chemprop.features import is_explicit_h
...
class MoleculeDatapoint:
    ...
    def mol(self) -> Union[List[Chem.Mol], List[Tuple[Chem.Mol, Chem.Mol]]]:
        ...
        # >>>
        if type(self.smiles[0]) is not str:
            return self.smiles

        # otherwise make Mol object
        mol = make_mols(self.smiles, self.is_explicit_h)
...
def make_mols(smiles: List[str], keep_h: bool):
    """
